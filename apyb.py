...
tokens = keywords + ('TYPE', 'LPAR', 'RPAR', 'LBRAC', 'RBRAC', 'HASH', 'WS',
...
def p_data_structs(p):
    ''' data_structs : HASH DATASTRUCTURES NEWLINE'''
...
def p_header_object(p):
    '''header_object : HASH TEXT type_def NEWLINE object_items
                     | HASH TEXT NEWLINE object_items
                     | HASH TEXT NEWLINE description NEWLINE object_items
                     | HASH TEXT type_def NEWLINE description NEWLINE object_items
                     | HASH TEXT type_def NEWLINE '''
